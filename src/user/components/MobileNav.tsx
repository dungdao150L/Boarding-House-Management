...
export default function MobileNav({ activeTab, setActiveTab, lang }: MobileNavProps) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full z-50 flex justify-around items-center px-2 py-2 pb-safe lg:hidden shadow-lg border-t border-[#e7e8e9] bg-[#ffffff] rounded-t-xl transition-colors duration-200">
      {navItems.map((item) => {
