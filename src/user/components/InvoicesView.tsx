        ...
        <div className="flex items-center gap-4 w-full md:w-auto">
          ...
          <div className="relative shrink-0">
            <select 
              ...
              className="appearance-none bg-[#ffffff] border border-[#c5c6cf] text-brand-primary font-semibold text-sm rounded-xl py-3 pl-4 pr-10 focus:outline-none focus:ring-1 focus:ring-brand-primary cursor-pointer"
            >
